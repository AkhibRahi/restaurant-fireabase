    ...
    <div className="w-full min-h-screen flex justify-center items-center">
      ...
      >
        ...
        <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
          ...
          font-semibold outline-none border-none placeholder:text-gray-400 text-textColor"
          />
        </div>
        ...
        flex-col border-2 border-dotted border-gray-300 w-full h-225 md:h-420 cursor-pointer rounded-lg"
        >
          {isLoading ? (
            <Loader />
          ) : (
        ...
        <div className="w-full h-full flex flex-col md:flex-row items-center gap-3">
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
